...
- (已处理)TODO：复制安卓测试成功，待测试ios
- (已处理)TODO：测试截屏保存图片到相册
   - TODO:写按区域截图代码
- 易宝支付实名相关逻辑 
...
# 2024年4月15日     星期一
- (已处理)TODO：主页 sell out


# 2024年4月16日     星期二
- (已处理)TODO：订单详情，已完成订单的uid显示
- (已处理)TODO：订单详情，按商品唯一ID查询，逻辑和UI完善

# 2024年4月18日     星期四
- TODO：测试新iOS开发者帐号是不是公司帐号，能不能进行企业签名

# 2024年4月19日     星期五
- (已处理)TODO：易宝支付测试
- TODO：iOS支付，iOS版本
- TODO：交易记录
- (已处理)TODO：登录界面的忘记密码还没做

# 2024年4月19日     星期六
- (已处理)TODO：我的订单，待付款里面的支付
- (已处理)TODO：帐号注销 
- (已处理)TODO：寄售记录中，交易中的无售卖下架按钮
- (已处理)TODO：金额相关小数点保留两位

# 2024年4月22日     星期一
- TODO：打开webview回到游戏，断线重连
   - webview层应该心跳就不发了
   - 延长心跳超时时间
- (已处理)TODO：消息过滤加到config表中
- (已处理)TODO：debug window从loginwindow移到setting window
- (已处理)TODO：ios二次审核passed处理



# 2024年4月24日     星期三
- (已处理)TODO：做个一键打非windows窗体的所有的其它预制件



- (已处理)TODO：打最近修改时间的预制件
- (已处理)TODO：验证码倒计时时间改为3分钟

# 2024年4月28日     星期日
- 今天五一假期调休，故今天上班。我们昨天周六休了1天
...
# 2024年5月1日     星期三
今天是五一假期，我们通知的是加班2，3，4三天，我今天过来加班，4号休息。
...
- TODO：分享界面二维码要换成正式的
- TODO：加微关注页面
- TODO：要检查所有页面，替换按钮，和一些字体颜色不协调的地方
- TODO：打新的安卓包
...
```c
1，无满足要求的技术支持网站
由于没有官网，前几天提审我填写的隐私政策网站，不合规。
不一定非要是官网这么复杂，有个有公司名称、地址、联系方式的网页即可。

2，支付内容被判定未非消耗型商品，需要提供恢复功能。

解决方法1：增加一个消耗型商品，比如金币，通过消耗型商品再购买矿车、飞船
解决方法2：提供恢复功能

3，无账号注销功能
这个应该是审核员未看到，下次提审添加备注即可

4，隐私数据收集
我理解的是可能购买实名导致的，可以增加判断，在审核时，购买无需实名
```
...
- TODO：好友邀请二维码换成正式的
- TODO：热更新整包更新安装换成正式URL，这个在serverlist里面配安卓的即可
- TODO：白名单功能要测试
- TODO: 要提前2天把安卓包给易宝唐总
- TODO：首发期间不生产功能  客户端加上限制

# 2024年6月2日        星期日 
在家休息，无奈超级腹泻，还发烧了。一天懵懵懂懂过去的，幸亏葫芦儿今天也休息。
thanks.

# 2024年6月11日     星期二
端午假期回来第一天
- 不再使用LoadSprite加载sprite，统一使用LoadSpriteToTarget
