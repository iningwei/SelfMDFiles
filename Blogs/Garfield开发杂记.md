...
## 20230919 星期二
- TODO：需要有一个专门记录玩家的脚本，用来在新关卡的时候创建Player和Actor
- TODO：有个记录玩家各个关卡得分信息的脚本，用来总榜上传数据


## 20230920 星期三
- TODO：捕狗猫车子改成无视碰撞，且遇到PushTarget不再前行
- （已处理）1-10大哥入场特效加玩家信息，采用UI overlay的方式
- （已处理）人数上限问题
- TODO：关卡2、3关卡进入后自动生成之前加入的玩家
- TODO：game02部分礼物需求变动，需要等美术资源调整到位后，我这边跟着调整
- TODO：game02到game03后，创建角色会报错

## 20230921 星期四
- 完善送礼提示逻辑
- 继承角色在新关卡自动加入游戏
- TODO：LoadOtherPrefab函数中reUse去除
- TODO：表情功能丢失？
